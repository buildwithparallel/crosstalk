<template>
    <div class="inline-flex rounded-md shadow-sm">
        ...
        <button @click="showMenu" type="button" aria-label="Add image" class="my-auto mr-1 inline-flex min-h-11 min-w-11 items-center justify-center gap-x-1 rounded-lg ct-secondary-button px-2.5 py-1.5 text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 sm:min-h-0 sm:min-w-0 sm:rounded-md">
