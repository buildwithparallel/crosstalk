<template>
    <div class="ct-card ct-card-hover overflow-visible" :class="{ 'opacity-70': !isInterfaceEnabled(iface) }">
        ...
        <div class="flex items-center py-2.5 px-1">

            <!-- icon -->
            <div class="mx-2 flex size-10 shrink-0 items-center justify-center rounded-lg border text-[#7db0ff]" :class="[ isInterfaceEnabled(iface) && iface._stats?.status === true ? 'border-[rgba(0,97,253,0.4)] bg-[rgba(0,97,253,0.12)] shadow-[0_0_18px_rgba(0,97,253,0.18)]' : 'border-[var(--ct-border)] bg-[rgba(255,255,255,0.04)] text-[var(--ct-dim)]' ]">

                <svg v-if="iface.type === 'AutoInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5">
                    <path d="M219.31,108.68l-80-80a16,16,0,0,0-22.62,0l-80,80A15.87,15.87,0,0,0,32,120v96a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V160h32v56a8,8,0,0,0,8,8h64a8,8,0,0,0,8-8V120A15.87,15.87,0,0,0,219.31,108.68ZM208,208H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48V120l80-80,80,80Z"></path>
                </svg>

                <svg v-else-if="iface.type === 'RNodeInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5">
                ...
                <svg v-else-if="iface.type === 'SerialInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5">
                ...
                <svg v-else-if="iface.type === 'RNodeMultiInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5"><path d="M128,88a40,40,0,1,0,40,40A40,40,0,0,0,128,88Zm0,64a24,24,0,1,1,24-24A24,24,0,0,1,128,152Zm73.71,7.14a80,80,0,0,1-14.08,22.2,8,8,0,0,1-11.92-10.67,63.95,63.95,0,0,0,0-85.33,8,8,0,1,1,11.92-10.67,80.08,80.08,0,0,1,14.08,84.47ZM69,103.09a64,64,0,0,0,11.26,67.58,8,8,0,0,1-11.92,10.67,79.93,79.93,0,0,1,0-106.67A8,8,0,1,1,80.29,85.34,63.77,63.77,0,0,0,69,103.09ZM248,128a119.58,119.58,0,0,1-34.29,84,8,8,0,1,1-11.42-11.2,103.9,103.9,0,0,0,0-145.56A8,8,0,1,1,213.71,44,119.58,119.58,0,0,1,248,128ZM53.71,200.78A8,8,0,1,1,42.29,212a119.87,119.87,0,0,1,0-168,8,8,0,1,1,11.42,11.2,103.9,103.9,0,0,0,0,145.56Z"></path></svg>

                <svg v-else-if="iface.type === 'I2PInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5"><path d="M72,92A12,12,0,1,1,60,80,12,12,0,0,1,72,92Zm56-12a12,12,0,1,0,12,12A12,12,0,0,0,128,80Zm68,24a12,12,0,1,0-12-12A12,12,0,0,0,196,104ZM60,152a12,12,0,1,0,12,12A12,12,0,0,0,60,152Zm68,0a12,12,0,1,0,12,12A12,12,0,0,0,128,152Zm68,0a12,12,0,1,0,12,12A12,12,0,0,0,196,152Z"></path></svg>

                <svg v-else-if="iface.type === 'KISSInterface' || iface.type === 'AX25KISSInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5"><path d="M104,168a8,8,0,0,1-8,8H64a8,8,0,0,1,0-16H96A8,8,0,0,1,104,168Zm-8-40H64a8,8,0,0,0,0,16H96a8,8,0,0,0,0-16Zm0-32H64a8,8,0,0,0,0,16H96a8,8,0,0,0,0-16ZM232,80V192a16,16,0,0,1-16,16H40a16,16,0,0,1-16-16V72a8,8,0,0,1,5.7-7.66l160-48a8,8,0,0,1,4.6,15.33L86.51,64H216A16,16,0,0,1,232,80ZM216,192V80H40V192H216Zm-16-56a40,40,0,1,1-40-40A40,40,0,0,1,200,136Zm-16,0a24,24,0,1,0-24,24A24,24,0,0,0,184,136Z"></path></svg>

                <svg v-else-if="iface.type === 'PipeInterface'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5"><path d="M128,128a8,8,0,0,1-3,6.25l-40,32a8,8,0,1,1-10-12.5L107.19,128,75,102.25a8,8,0,1,1,10-12.5l40,32A8,8,0,0,1,128,128Zm48,24H136a8,8,0,0,0,0,16h40a8,8,0,0,0,0-16Zm56-96V200a16,16,0,0,1-16,16H40a16,16,0,0,1-16-16V56A16,16,0,0,1,40,40H216A16,16,0,0,1,232,56ZM216,200V56H40V200H216Z"></path></svg>

                <svg v-else xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256" class="size-5">
            ...
            <!-- interface details -->
            <div class="min-w-0">
                <div class="font-semibold leading-5 text-[var(--ct-text)]">{{ iface._name }}</div>
                <div class="text-sm flex space-x-1 text-[var(--ct-dim)]">
            ...
            <div class="ml-auto my-auto mr-2">
                <span v-if="isInterfaceEnabled(iface)" class="inline-flex items-center gap-x-1 rounded-full bg-[rgba(46,231,129,0.12)] px-2 py-1 text-xs font-medium text-[#5df2a4] ring-1 ring-inset ring-[rgba(46,231,129,0.35)]">Enabled</span>
                <span v-else class="inline-flex items-center gap-x-1 rounded-full bg-[rgba(255,255,255,0.06)] px-2 py-1 text-xs font-medium text-[var(--ct-dim)] ring-1 ring-inset ring-[var(--ct-border-strong)]">Disabled</span>
            </div>

            <!-- enable/disable interface button -->
            <div class="my-auto mr-1">
                <button v-if="isInterfaceEnabled(iface)" @click="disableInterface" title="Turn off" type="button" class="cursor-pointer">
                    <span class="flex rounded-full border border-[var(--ct-border)] bg-[rgba(255,255,255,0.06)] p-2 text-[var(--ct-muted)] transition hover:bg-[rgba(255,255,255,0.1)]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5.636 5.636a9 9 0 1 0 12.728 0M12 3v9" />
                        </svg>
                    </span>
                </button>
                <button v-else @click="enableInterface" title="Turn on" type="button" class="cursor-pointer">
                    <span class="flex rounded-full border border-[rgba(46,231,129,0.4)] bg-[rgba(46,231,129,0.1)] p-2 text-[#5df2a4] transition hover:bg-[rgba(46,231,129,0.18)]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5.636 5.636a9 9 0 1 0 12.728 0M12 3v9" />
                        </svg>
                    </span>
            ...
            <div class="my-auto mr-1">
                <button @click="deleteInterface" title="Delete interface" type="button" class="cursor-pointer">
                    <span class="flex rounded-full border border-[rgba(255,59,87,0.35)] bg-[rgba(255,59,87,0.1)] p-2 text-[#ff8298] transition hover:bg-[rgba(255,59,87,0.2)]">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <div class="my-auto mr-2">
                <DropDownMenu>
                    ...
                    <template v-slot:items>
                        ...
                        <!-- enable/disable interface button -->
                        <div class="border-b border-[var(--ct-border)]">
                        ...
                        <!-- delete interface button -->
                        <div class="border-t border-[var(--ct-border)]">
...
export default {
    ...
    methods: {
        onIFACSignatureClick: function(ifacSignature) {
            DialogUtils.alert(ifacSignature, { title: "IFAC Signature" });
        },
